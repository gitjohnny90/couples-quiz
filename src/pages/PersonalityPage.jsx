    ...
    <div className="page" style={{ position: 'relative' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 18 }}>
          <h1 style={{ fontFamily: 'var(--font-hand)', fontSize: '2rem', fontWeight: 700 }}>personality tests</h1>
          <SquigglyUnderline width={130} color="#E88D7A" opacity={0.4} style={{ margin: '0 auto 6px' }} />
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.5, maxWidth: 340, margin: '0 auto' }}>
            fill in your personality tests, then compare side by side to see where you click and where you balance each other out
          </p>
